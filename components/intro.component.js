...
export default function Intro() {
  return (
    <section id="content" className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <p>
        <strong>East: Sun - Rise ARI</strong> is a FY 21-22 Community Initiatives project awarded by City of Austin Cultural Arts Funding Program and the Economic Development Department and sponsored by The Museum of Human Achievement, a 503c non-profit org based in Austin, Texas and supported by Austin Mutual Aid Micro-grant.
      </p>
      </div>
    </section>
  );
