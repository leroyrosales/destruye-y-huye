...
export default function Header() {
  ...
  return (
    <section className="bg-gradient-to-r py-8 mb-16 py-8">
        <div className={`flex flex-col px-5 md:px-10 z-30 xl:flex-row justify-between xl:items-center ${show ? "w-full fixed-nav bg-white" : ""}`}>
